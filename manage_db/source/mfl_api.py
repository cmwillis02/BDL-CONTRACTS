...
class Export():
    ...
    def __init__(self, year, week, mfl_connection):
        ...
        self.year= year
        self.week= week
        self.league_id= mfl_connection[0]
        self.username= "cmwillis02"
        self.password= "02guam04"
        self.proto= "https://"
        self.host= "www{}.myfantasyleague.com/".format(mfl_connection[1])
        self.export_url= "{}{}{}/export".format(self.proto, self.host, self.year)
    ...
    def login(self):
        ...
        self.logger.info("Logging in to MFL")
        login_url= 'https://api.myfantasyleague.com/{}/login?USERNAME={}&PASSWORD={}&XML=1'.format(self.year, self.username, self.password)
        self.logger.debug("URL= {}".format(login_url))

        self.session.get(login_url)
        self.logger.info("Session Login Response")
